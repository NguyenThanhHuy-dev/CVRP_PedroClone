...
run_all_A.py
============
Chạy lần lượt 3 method: gurobi → cplex → pysat cho benchmark A-Set.
Sử dụng: python run_all_A.py
"""
...
def main():
    ...
    print("=" * 70)
    print("AUTO RUNNER  |  BENCHMARK A-SET  |  3 METHODS")
    print("=" * 70)
    ...
    for method in METHODS:
        ...
        start = time.time()
        ret = subprocess.run(
            [sys.executable, "run_benchmark_A.py", method],
            check=False,
        )
