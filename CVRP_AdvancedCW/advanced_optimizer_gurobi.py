...
# -*- coding: UTF-8 -*-
"""
Advanced CVRP Optimizer using 100% Gurobi (Single & Pairwise)
=============================================================
"""
...
# =====================================================================
# ADVANCED CVRP OPTIMIZER (100% Gurobi)
# =====================================================================
...
def solve_advanced(filepath: str, config: Dict[str, Any] = None, max_iterations: int = 50):
    ...
    logging.info("--- Step 3: Advanced Optimization (100% Gurobi) ---")
    ...
    logging.info(f"  3. Chi phí sau Gurobi:        {final_int_cost}")
    logging.info(f"  => TỔNG CẢI THIỆN:            {cw_cost - final_int_cost}")
    logging.info(f"  => Số lần Gurobi Single cải thiện  : {stats['single_imp_count']} lần")
    logging.info(f"  => Số lần Gurobi Pairwise cải thiện: {stats['pairwise_imp_count']} lần")
